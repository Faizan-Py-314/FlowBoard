        ...
        <div className='flex flex-col items-center w-80 border rounded-lg p-4 gap-3 sm:w-100 md:w-120 md:p-8'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col items-center text-center w-full'>
            ...
            <div className='mt-3 w-full flex flex-col gap-2 md:gap-3 md:mt-5'>
              <div>
                <p className={`${inputError == 'NameLengthError'? 'block':'hidden'} w-full text-start text-red-300 -mt-2 ml-2 text-xs md:text-sm`}>Name must be at least 3 characters long</p>
              ...
              <div>
                <p className={`${inputError == 'UsernameLengthError'? 'block':'hidden'} w-full text-start text-red-300 -mt-2 ml-2 text-xs md:text-sm`}>Username must be at least 5 characters long</p>
              ...
              <div>
                <p className={`${inputError == 'MailEmptyError'? 'block':'hidden'} w-full text-start text-red-300 -mt-2 ml-2 text-xs md:text-sm`}>Email must not be Empty</p>
              ...
              <div>
                <p className={`${inputError == 'PasswordError'? 'block':'hidden'} w-full text-start text-red-300 -mt-2 ml-2 text-xs md:text-sm`}>Password must be at least 8 characters long</p>
