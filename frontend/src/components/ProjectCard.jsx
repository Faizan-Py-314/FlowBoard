    ...
    <div className='border border-gray-400 p-4 rounded-lg w-full'>
        ...
        <div className='flex flex-col gap-1 mt-2'>
            ...
            <div className='flex gap-2 items-center mt-2'>
                <button onClick={async () => {await getProject(project.id); setFeatureIsOpen(true)}} className='py-2 px-3 bg-black text-white rounded-md text-sm cursor-pointer'>View Tasks</button>
