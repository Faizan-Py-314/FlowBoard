...
import { RiSwap3Fill, RiCloseFill, RiHome9Fill, RiTodoLine, RiTrelloLine, RiCalendarTodoLine } from "@remixicon/react";
...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`p-4 w-full h-svh brs ${navActive? 'block':'hidden'} lg:w-1/5 lg:px-3 2xl:w-1/6`}>
        <div className='flex items-center justify-between'>
          ...
          <hr className='my-3'/>
        <ul className='px-2 flex flex-col gap-1 lg:p-0 xl:gap-2'>
